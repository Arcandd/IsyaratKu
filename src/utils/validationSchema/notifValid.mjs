export const createNotificationValidationSchema = {
  ...
  status: {
    notEmpty: {
      errorMessage: "Notification status can not be empty if provided",
    },
    isIn: {
      options: [["Not Read", "Read"]],
      errorMessage:
        "Notification status must be either 'Not Read' or 'Read' if provided",
    },
    isString: {
      errorMessage: "Notification status must be a string if provided",
    },
    optional: true,
  },
};
